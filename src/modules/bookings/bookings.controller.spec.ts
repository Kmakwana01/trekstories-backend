...
describe('Bookings Controllers', () => {
    ...
    const mockBookingsService = {
        ...
        adminUpdateStatus: jest.fn().mockResolvedValue({ id: '1', status: 'confirmed' }),
        adminConfirmBooking: jest.fn().mockResolvedValue({ id: '1', status: 'confirmed' }),
    ...
    beforeEach(async () => {
        ...
        adminController = module.get<AdminBookingsController>(AdminBookingsController);
    ...
    describe('AdminBookingsController', () => {
        it('should call adminGetAllBookings', async () => {
            ...
            expect(service.adminGetAllBookings).toHaveBeenCalledWith({ status: 'pending' });
        });
