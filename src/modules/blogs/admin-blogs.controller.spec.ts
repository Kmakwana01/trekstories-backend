...
describe('AdminBlogsController', () => {
    ...
    it('should create a blog', async () => {
        ...
        await controller.create(dto as any, undefined as any, mockUser as any, mockReq as any);
    ...
    it('should update a blog', async () => {
        ...
        await controller.update('1', dto as any, undefined as any, mockUser as any, mockReq as any);
