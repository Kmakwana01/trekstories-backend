...
describe('Coupons Controllers', () => {
    ...
    const mockCouponsService = {
        validateCoupon: jest.fn().mockResolvedValue({ valid: true, discountAmount: 100 }),
    ...
    beforeEach(async () => {
        ...
        adminController = module.get<AdminCouponsController>(AdminCouponsController);
    ...
    describe('CouponsController', () => {
        it('should validate a coupon', async () => {
            ...
            expect(service.validateCoupon).toHaveBeenCalledWith(dto.code, mockUser._id, dto.tourId, dto.orderAmount);
        });
    });
